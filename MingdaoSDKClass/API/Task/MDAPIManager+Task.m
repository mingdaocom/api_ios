                                  ...
                                  handler:(MDAPINSStringHandler)handler
{
    ...
    [parameters addObject:@{@"key":@"visibility", @"object":@(visibility)}];
    if (visibility == 1) {
        [parameters addObject:@{@"key":@"groupIDs", @"object":groupIDs}];
    }
    if (fileID) {
        [parameters addObject:@{@"key":@"fFileID", @"object":fileID}];
    }
...
{
    NSMutableString *urlString = [self.serverAddress mutableCopy];
    [urlString appendString:@"/task/v4/removeFolderMember.aspx?format=json"];
    [urlString appendFormat:@"&access_token=%@", self.accessToken];
    [urlString appendFormat:@"&t_folderID=%@", folderID];
    [urlString appendFormat:@"&u_id=%@", userID];
...
{
    NSMutableString *urlString = [self.serverAddress mutableCopy];
    [urlString appendString:@"/task/v4/addFolderMember.aspx?format=json"];
    [urlString appendFormat:@"&access_token=%@", self.accessToken];
    [urlString appendFormat:@"&t_folderID=%@", folderID];
    [urlString appendFormat:@"&members=%@", members];
